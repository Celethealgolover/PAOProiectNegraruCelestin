...
public class MedicGastroenterolog extends Medic{
    ...
    public MedicGastroenterolog(){}
    public MedicGastroenterolog(String nume, String prenume, String email, String grad, String specializare, int numarTelefon, int aniExperienta,int salariu)
    {
